...
from src.utils import convertir, comparar
...
print(f"listo, tu conversión resulta en que {valor_unidad_a_convertir} {unidad_a_convertir} equivalen a", convertir(unidad_a_convertir, valor_unidad_a_convertir, equivalencias), comparar(unidad_a_convertir, valor_unidad_a_convertir,comparadas))